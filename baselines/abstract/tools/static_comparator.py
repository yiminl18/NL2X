...
def compare_schemas(
    ...
    # Case 1: Both have 'fields' - compare field by field
        ...
        for field in all_fields:
            if field not in fields1:
                ...
                try:
                    ...
                    # If type checking fails, do string comparison
    ...
    # Case 2: One or both are simple type schemas (no 'fields')
    else:
...
def compare_pipelines(
    ...
    # Step 1: Validate both pipelines individually
    ...
    # If either pipeline is invalid, return early
    ...
    # Add warnings about pipeline length differences
